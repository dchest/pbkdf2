...
// PBKDF2 derives key of length outlen from the provided password, salt, 
...
func PBKDF2(password []byte, salt []byte, iterations int, hash func() hash.Hash, outlen int) []byte {
